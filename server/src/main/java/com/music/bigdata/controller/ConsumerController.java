...
//    }
    ...
    public Message updateInfo(
        ...
        if (data.containsKey("passwd")) {
            return accountService.updatePasswd(id, data.get("passwd").toString());
        }
        if (data.containsKey("phone")) {
            return accountService.updatePhone(id, data.get("phone").toString());
        }
        if (data.containsKey("e_mail")) {
            return accountService.updateEmail(id, data.get("e_mail").toString());
        }
    ...
    public Message findSame(
        ...
        if (!Objects.equals(adminName, "")) {
            return accountService.findSameName(adminName);
        }
        if (!Objects.equals(phone, "")) {
            return accountService.findSamePhone(phone);
        }
        if (!Objects.equals(e_mail, "")) {
            return accountService.findSameEmail(e_mail);
        }
        return new ErrorMessage("参数错误");
    }
